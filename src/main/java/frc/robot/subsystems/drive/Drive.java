...
public class Drive extends SubsystemBase {
  ...
  public Drive(
    ...
    sysId = new SysIdRoutine(
      ...
      // Set initial pose in SIM to correct starting position on field for better odometry in the early part of auto paths. 
      // This is not needed on the real robot since the gyro will provide an accurate heading from the start.
