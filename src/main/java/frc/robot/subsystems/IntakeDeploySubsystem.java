...
SparkMax motor3 = new SparkMax(59, MotorType.kBrushless);
  ...
  public IntakeDeploySubsystem() {
    // lc.setRangingMode.LaserCan.RangingMode.SHORT lc; setRegionOfInterest(new LaserCan.RegionOfInterest(8, 8, 16, 16));
      // lc.setTimingBudget(LaserCan.TimingBudget.TIMING_BUDGET_33MS ); lc.setRegionOfInterest(new LaserCan.RegionOfInterest(8, 8, 16, 16));
