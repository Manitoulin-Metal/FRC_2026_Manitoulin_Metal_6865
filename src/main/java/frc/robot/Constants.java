...
public final class Constants {
  ...
  public static class AlignToTag {
    ...
    public static final LoggedNetworkNumber targetXEntry = new LoggedNetworkNumber(
        "/SmartDashboard/AlignToTag/TargetX", DEFAULT_TARGET_POSE_RELATIVE_TO_TAG.getX());
    public static final LoggedNetworkNumber targetYEntry = new LoggedNetworkNumber(
