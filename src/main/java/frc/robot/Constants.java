...
public final class Constants {
  ...
  public static class AlignToTag {
    // The pose below is the target pose of the robot relative to the AprilTag for
    // climb.
    public static final Pose2d DEFAULT_TARGET_POSE_RELATIVE_TO_TAG =
        new Pose2d(-0.65, 0.10, Rotation2d.fromDegrees(180.0));

    public static final LoggedNetworkNumber targetXEntry =
        new LoggedNetworkNumber(
            "/SmartDashboard/AlignToTag/TargetX", DEFAULT_TARGET_POSE_RELATIVE_TO_TAG.getX());
    public static final LoggedNetworkNumber targetYEntry =
        new LoggedNetworkNumber(
            "/SmartDashboard/AlignToTag/TargetY", DEFAULT_TARGET_POSE_RELATIVE_TO_TAG.getY());
    public static final LoggedNetworkNumber targetHeadingDegEntry =
        new LoggedNetworkNumber(
