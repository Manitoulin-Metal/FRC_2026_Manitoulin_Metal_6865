...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                // This loads the autos for the technician to choose an auto on
        ...
        private void configureButtonBindings() {
                                ...
                                .onTrue(
                                                Commands.runOnce(
                                                                () -> {
                                                                        ...
                                                                        SmartDashboard.putBoolean("Drive/RobotCentric",
                                                                                        robotCentric);
                                                                }));
                                ...
                                .onTrue(
                                                Commands.runOnce(
                                                                () -> {
                                                                        ...
                                                                        SmartDashboard.putBoolean("Vision Enabled",
                                                                                        visionEnabled);
                                                                }));
                ...
                // Clear shooter sticky faults (formerly leftBumper)
                operator.rightBumper().onTrue(shooter.clearFaultsCommand());

                // Run intake in reverse while left bumper is held
                operator.leftBumper().whileTrue(intakeRoller.intakeReverseCommand());
        }
