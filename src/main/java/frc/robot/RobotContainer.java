...
public class RobotContainer {
  ...
  /**
   * Homes the intake subsystem on robot initialization. - If hall sensor shows intake is stowed,
   * reset encoder to 0. - If not stowed, schedule the stow command to move intake to stowed
   * position.
   */
