  ...
  public static Command driveToShoot(
    ...
    return Commands.run(
            () -> {
              ...
              Logger.recordOutput("DriveToShoot/TargetPose", targetPose);
              ...
              // P Control
              // ---------------------------------------------------
              double xSpeed = (targetPose.getX() - currentPose.getX()) * kPLinear;

              double ySpeed = (targetPose.getY() - currentPose.getY()) * kPLinear;
